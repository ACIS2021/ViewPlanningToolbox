...
class RenderQueueManager:
    def __init__(self, x_res, y_res, focal_length, initial_shape_path, blender_path):
        ...
        self.process = multiprocessing.Process(target=render_pose,
                                               args=(
                                               x_res, y_res, focal_length, self.command_queue, self.data_queue, initial_shape_path, blender_path))
        self.process.start()
